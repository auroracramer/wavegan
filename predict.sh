...
python predict.py --model-size 64 --post-proc-filt-len 512 --batch-size 64 --ngpus 1 --latent-dim 100 --output_dir=output --num_categ=3 --job_id=$SLURM_JOB_ID --model_path=/users/PAS2062/delijingyic/project/org_wavegan/output/17471472/model/581 --random_range=1 --num_epochs=60 > "output/${SLURM_JOB_ID}/stdout.log"
