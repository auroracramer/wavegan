...
python manipulate.py --model-size 64 --post-proc-filt-len 512 --batch-size 64   --ngpus 1 --latent-dim 100 --output_dir=output --num_categ=3 --job_id=$SLURM_JOB_ID --model_path=/users/PAS2062/delijingyic/project/org_wavegan/output/17411075/model/250 --random_range=10 > "sbatch/${SLURM_JOB_ID}_main.log"